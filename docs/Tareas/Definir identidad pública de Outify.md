...
- [ ] Paquete de iconos exportado en formatos web necesarios.
- [ ] Dominio elegido y documentado.
- [ ] Metadatos del navegador y redes sociales definidos.
- [ ] Recursos optimizados, versionados y aplicados a una build verificable.
